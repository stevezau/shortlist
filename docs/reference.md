...
| `sync.watch_cron`                                     | `""` (daily 04:17)                 | cron expression for the watch-history sync schedule. Blank = built-in default. Set from the Tools page frequency picker or a custom cron                                                                                                                                                                                                                                                                |
